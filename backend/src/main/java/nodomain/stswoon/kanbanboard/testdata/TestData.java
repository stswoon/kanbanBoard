...
public class TestData {
    ...
    public void initTestData() {
        ...
        ticketService.save(new TicketEntity(null, boardId, "Demo", null, null, null, 0));
        ticketService.save(new TicketEntity(null, boardId, "Code review + fix todos", null, null, null, 0));
        ticketService.save(new TicketEntity(null, boardId, null, null, null, null, 0));
    }
